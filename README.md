...
- [Fair Housing Project](https://github.com/aminrahimian/data-for-good/blob/main/project/PreviousProjects/HousingProject/housing-project.ipynb) - A class project for Professor Amin Rahimian's Data for Social Good course at the University of Pittsburgh. Demonstrates joining tables, cleaning, and analyzing using Pandas dataframes. Also demonstrates geocoding and mapping, and uses the [Community Assets dataset](https://data.wprdc.org/dataset/allegheny-county-assets) for Allegheny County.
